        ...
        <div className="bg-pr-dark-gray font-sans text-gray-300 min-h-screen">
            <nav className="bg-pr-dark border-b border-pr-gray/20 fixed w-full z-20 top-0 start-0">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to="/cliente/home" className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <div className="flex items-center md:order-2 space-x-3 rtl:space-x-reverse">
                        ...
                        <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-pr-yellow" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            ...
                            <img className="w-8 h-8 rounded-full" src="https://placehold.co/40x40/FFC700/121212?text=C" alt="foto de usuario" />
                        </button>
                        <div className="z-50 hidden my-4 text-base list-none bg-pr-dark divide-y divide-gray-600 rounded-lg shadow" id="user-dropdown">
                            <div className="px-4 py-3">
                                <span className="block text-sm text-white">{userData?.rol || 'Cliente'}</span>
            ...
            <div className="flex mt-16">
                <aside id="sidebar-cliente" className={`fixed top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] bg-pr-dark p-4 space-y-6 shrink-0 transition-transform md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                    <div>
                        <h3 className="font-bold text-white text-lg mb-4">Menú Cliente</h3>
                        <ul className="space-y-2">
                            <li><Link to="/cliente/stock" className="flex items-center gap-3 text-gray-300 hover:text-pr-yellow py-2 px-3 rounded-lg hover:bg-pr-dark-gray transition-colors"><FontAwesomeIcon icon={faBookOpen} className="w-5 text-center text-lg" /> Productos</Link></li>
                            <li><Link to="/cliente/perfil" className="flex items-center gap-3 text-gray-300 hover:text-pr-yellow py-2 px-3 rounded-lg hover:bg-pr-dark-gray transition-colors"><FontAwesomeIcon icon={faUser} className="w-5 text-center text-lg" /> Perfil</Link></li>
                        </ul>
                    </div>
                </aside>
