...
// Importamos los modales que hemos creado. ¡Reutilización en acción!
// NOTA: La ruta cambia ligeramente porque estamos en la carpeta 'empleado' en lugar de 'jefe'
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                ...
                {/* --- MODIFICACIÓN: Se elimina el botón de "Gestionar Categorías" --- */}
            </div>
                                ...
                                <div className="p-4 flex flex-col justify-between w-2/3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex justify-end items-center gap-4">
                                            ...
                                            {/* --- MODIFICACIÓN: Se elimina el botón de "Eliminar" --- */}
                                        </div>
                                    </div>
                                </div>
                            </div>
