...
import { faBoxOpen, faPlusCircle, faAddressBook, faMoneyBillWave, faChartBar } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <Layout>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <Link to="/control-stock" className="block bg-pr-dark p-6 rounded-lg shadow-lg hover:shadow-pr-yellow/20 hover:-translate-y-1 transition-all duration-300">
                ...
                <Link to="#" className="block bg-pr-dark p-6 rounded-lg shadow-lg hover:shadow-pr-yellow/20 hover:-translate-y-1 transition-all duration-300">
