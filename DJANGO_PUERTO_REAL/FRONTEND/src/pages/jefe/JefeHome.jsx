        ...
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <Link to="/jefe/settings" className="card-base hover:shadow-pr-yellow/20">
                    ...
                    <p className="text-gray-400 text-sm">Gestiona ajustes del sistema y usuarios.</p>
                </Link>
                ...
                <Link to="/jefe/analysis" className="card-base hover:shadow-pr-yellow/20">
                    ...
                    <p className="text-gray-400 text-sm">Genera un resumen de las ventas y movimientos.</p>
                </Link>
