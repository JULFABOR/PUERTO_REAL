...
import OpenCajaModal from '@/components/Modals/Caja/OpenCajaModal'; // <-- ¡Nombre corregido!
import MovimientoCajaModal from '@/components/Modals/Caja/MovimientoCajaModal'; // <-- Reutilizado
...
const JefeCaja = () => {
    ...
    const difference = realBalance !== '' ? parseFloat(realBalance) - theoreticalBalance : null;
        ...
        const handleMovementSuccess = () => {
            // Al tener éxito, simplemente cerramos el modal.
            // El hook 'useCaja' ya se encarga de refrescar los datos.
        ...
        return (
            <>
                ...
                /* ======================= VIEW: CASH OPEN ======================= */
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-8">
                            <button onClick={() => setShowMovementModal({ show: true, type: 'INGRESO' })} className="btn-primary w-full sm:w-auto">
                                ...
                                >
                                    ...
                                    <span>{isSubmitting ? 'Cerrando...' : 'Confirmar y Cerrar Caja'}</span>
                                        ...
                                        <ConfirmDeleteModal
                                            ...
                                            onConfirm={confirmCloseCaja}
                                            itemName={`el cierre de caja por $${realBalance || '0'}`}
                                        />
                            </div>
                        </div>
                    </div>
                ...
                <MovimientoCajaModal
                    ...
                    registerMovement={(monto, motivo) => registerMovement(monto, motivo, showMovementModal.type)}
                    isSubmitting={isSubmitting}
                />        </>
    );
};
