...
from .api_views import CustomAuthToken, LogoutView, RequestPasswordResetView, PasswordResetConfirmView, RegisterView, UserDataView, UsersAdminView, ChangePasswordView
